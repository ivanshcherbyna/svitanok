		...
		public function setSections() {
			...
			$footer_fields = array(
                array(
                    'id' =>'footer-text',
                    'type' => 'editor',
                    'title' => __('Текст в подвале', THEME_OPT)

                ),
                array(
                    'title' => __('Логотип для подвала', THEME_OPT),
                    'type' => 'media',
                    'id' =>'logo-footer-img'
                ),
            ...
            $header_fields = array(
                ...
                array(
                    ...
                    'type' => 'text',
                    'id' =>'text-header-phone-num'
                ),
                array(
                    'title' => __('Контактный адрес', THEME_OPT),
                    'type' => 'text',
                    'id' =>'text-header-adress'
                ),
