...
<div class="blog_article-sidebar">
    ...
    <div class="blog_article-sidebar-social">
        <div class="blog_article-sidebar-social-item">
            <a id="share_btn_gl" href="https://plus.google.com/share?url=<?= get_the_permalink()?>" class="blog_article-sidebar-social-item-link" target="_blank"><img src="../../../wp-content/themes/Svitanok/inc/urich/img/google-plus.png" alt="#"></a>
        ...
        <div class="blog_article-sidebar-social-item">
            <a id="share_btn_tw" href="https://twitter.com/home?status=' <?= get_the_permalink()?> '" class="blog_article-sidebar-social-item-link" target="_blank"><img src="../../../wp-content/themes/Svitanok/inc/urich/img/twitter.png" alt="#"></a>
